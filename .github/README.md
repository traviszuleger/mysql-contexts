...
```
2.) In the same directory as the Dockerfile, create a new file called "initdb.sql" with the contents from [here](https://github.com/traviszuleger/mysql-contexts/blob/main/lib/src/examples/initdb.sql)  
