...
export class MySqlTableContext {
    ...
    /**
     * @param {(m: Required<{[K in keyof OnlyAbstractModelArrays<TTableModel>]: { from: RelationshipFrom<TTableModel, OnlyAbstractModelArrays<TTableModel>[K]>}}>) => void} relationshipCallback
     */
    ...
    /**
     * @param {(m: Required<{[K in keyof OnlyAbstractModels<TTableModel>]: { from: RelationshipFrom<TTableModel, OnlyAbstractModels<TTableModel>[K]> }}>) => void} relationshipCallback
     */
    ...
    */
    ...
    /**
     * @template {AbstractModel} TJoiningTableModel
     * @param {IncludeCallback<TTableModel>} modelCallback 
     */
