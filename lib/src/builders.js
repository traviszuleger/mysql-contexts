//@ts-check
/** @template TModel @template TKey @typedef {import('./types.js').KeyByValueType<TModel,TKey>} KeyByValueType */
/** @template TModel @typedef {import('./types.js').OrderByFunction<TModel>} OrderByFunction */
